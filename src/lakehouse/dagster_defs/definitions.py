...
from lakehouse.dagster_defs.assets import bronze_carbon_intensity
from lakehouse.dagster_defs.checks import bronze_carbon_intensity_schema_check
...
defs = Definitions(
    assets=[bronze_carbon_intensity],
    asset_checks=[bronze_carbon_intensity_schema_check],
    jobs=[bronze_carbon_intensity_job],
    schedules=[bronze_carbon_intensity_schedule],
)